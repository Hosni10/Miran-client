...
} from "../../api/primeSubscribers";

const DEFAULT_PAGE_SIZE = 20;

// Props interface for the component
interface PrimeSubscribersTabProps {
  searchQuery?: string;
...
const PrimeSubscribersTab: React.FC<PrimeSubscribersTabProps> = ({
  searchQuery = "",
  onUpdateSearchParams,
}) => {
  ...
  const { data, isFetching, isError, error, refetch } = useQuery({
    ...
    queryFn: async (): Promise<PaginatedSubscribers> => {
      ...
      if (window.__MIRAN_DEBUG) {
        console.info("[PrimeSubscribers] Fetching page with backend search:", {
          page,
          offset,
...
export default PrimeSubscribersTab;
